...
install:
	...
	$(INSTALL) -d -m 755 $(DESTDIR)/usr/lib/systemd/system/bone-capemgr.target.wants
	...
	ln -fs ../bone-capemgr.target $(DESTDIR)/usr/lib/systemd/system/sysinit.target.wants/bone-capemgr.target
